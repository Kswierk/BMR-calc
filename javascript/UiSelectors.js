...
class Elements {
    ...
    addElement(query, name, withErrorInput = false) {
...
caloriesIntakeSection.addElement('[data-calories-perday]', 'dailyIntake');
caloriesIntakeSection.addElement('[data-calories-perweek]', 'weeklyIntake');
...
caloriesIntakeSection.addElement('[data-moderate]', 'moderateActivity');
caloriesIntakeSection.addElement('[data-high-moderate]', 'highModerateActivity');
...
macrosSectionElements.addElement('[data-maintenance]', 'maintenanceButton');
macrosSectionElements.addElement('[data-cutting]', 'cuttingButton');
macrosSectionElements.addElement('[data-bulking]', 'bulkingButton');
macrosSectionElements.addElement('[data-moderate-protein]', 'moderateProteinVal');
macrosSectionElements.addElement('[data-moderate-fats]', 'moderateFatsVal');
macrosSectionElements.addElement('[data-moderate-carbs]', 'moderateCarbsVal');
macrosSectionElements.addElement('[data-keto-protein]', 'ketoProteinVal');
macrosSectionElements.addElement('[data-keto-fats]', 'ketoFatsVal');
macrosSectionElements.addElement('[data-keto-carbs]', 'ketoCarbsVal');
macrosSectionElements.addElement('[data-highCarb-protein]', 'highCarbProteinVal');
