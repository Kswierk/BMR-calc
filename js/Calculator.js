class Calculator {
  ...
  caloriesIntake() {
    this.dailyIntake = document.querySelector(
      '.calories-number__perday'
    );
    this.weeklyIntake = document.querySelector(
      '.calories-number__perweek'
    );
    ...
    this.moderateCaloriesRate = document.querySelector(
      '.moderate__span'
    );
    ...
    if (this.gender.value === 'male') {
      ...
      this.lowCaloriesRate.innerHTML = Math.floor(
        this.mensBase * 1.2
      );
      this.moderateCaloriesRate.innerHTML = Math.floor(
        this.mensBase * 1.375
      );
      this.highModerateCaloriesRate.innerHTML = Math.floor(
        this.mensBase * 1.55
      );
      this.highCaloriesRate.innerHTML = Math.floor(
        this.mensBase * 1.725
      );
      this.vhighCaloriesRate.innerHTML = Math.floor(
        this.mensBase * 1.9
      );
    } else {
      ...
      this.moderateCaloriesRate.innerHTML = Math.floor(
        this.womensBase * 1.375
      );
      this.highModerateCaloriesRate.innerHTML = Math.floor(
        this.womensBase * 1.55
      );
      this.highCaloriesRate.innerHTML = Math.floor(
        this.womensBase * 1.725
      );
      this.vhighCaloriesRate.innerHTML = Math.floor(
        this.womensBase * 1.9
      );
  ...
  properWeight() {
    ...
    this.robinsonFormula = document.querySelector(
      '.robinson__number'
    );
  ...
  caloriesBold() {
    ...
    this.moderate = document.querySelector(
      '.moderate__calories-rate'
    );
    this.highModerate = document.querySelector(
      '.high-moderate__calories-rate'
    );
